...
final class Version20220513123715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lap_time (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, car_id INT NOT NULL, track_id INT NOT NULL, date DATETIME NOT NULL, time VARCHAR(255) NOT NULL, is_practice TINYINT(1) NOT NULL, extra_notes VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_30163F4EE48FD905 (game_id), INDEX IDX_30163F4EC3C6F69F (car_id), INDEX IDX_30163F4E5ED23C43 (track_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
